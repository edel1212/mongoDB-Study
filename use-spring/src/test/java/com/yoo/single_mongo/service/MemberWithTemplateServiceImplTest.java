...
class MemberWithTemplateServiceImplTest {
    ...
    void deleteMember() throws Exception{
        memberWithTemplateService.registerMember("zero2", 3);
        memberWithTemplateService.deleteMember("zero2");
    }

    @DisplayName("all Member")
    @Test
    void findAllMember() throws Exception{
        memberWithTemplateService.getAllMember()
    ...
    void findByAccountId() throws Exception{
        Member member = memberWithTemplateService.findOneByAccountId("edel1212");
        System.out.println("------------------------------");
        System.out.println(member);
        System.out.println("------------------------------");
    }
    ...
    void findByAgeGreaterThan() throws Exception{
        List<Member> memberList = memberWithTemplateService.findByAgeGreaterThan(555);
        System.out.println("------------------------------");
    ...
    void findByAgeGreaterThanEqual() throws Exception {
        List<Member> memberList = memberWithTemplateService.findByAgeGreaterThanEqual(50);
        System.out.println("------------------------------");
    ...
    void findByAgeLessThan() throws Exception {
        List<Member> memberList = memberWithTemplateService.findByAgeLessThan(32);
        System.out.println("------------------------------");
        memberList.forEach(System.out::println);
        System.out.println("------------------------------");
    }
    ...
    void findByAgeLessThanEqual() throws Exception {
        List<Member> memberList = memberWithTemplateService.findByAgeLessThanEqual(32);
        System.out.println("------------------------------");
        memberList.forEach(System.out::println);
        System.out.println("------------------------------");
    }
    ...
    void findByJoinedDateBetween() throws Exception {
        ...
        List<Member> memberList = memberWithTemplateService.findByJoinedDateBetween(startDate, endDate);
        System.out.println("------------------------------");
        memberList.forEach(System.out::println);
        System.out.println("------------------------------");
    }
    ...
    void getPageList() throws Exception {
        ...
        Page<Member> memberList = memberWithTemplateService.getPageMembers(pageable);
        System.out.println("------------------------------");
